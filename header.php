<head>
    ...
    <link rel="stylesheet" href="/m183_xss_and_injection/styles.css">
</head>
<nav class="navbar navbar-expand-lg navbar navbar-dark bg-primary">
    <a class="navbar-brand" href="#">OWASP Risks Live Demo</a>
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            <a class="nav-item nav-link" href="/m183_xss_and_injection/xss/reflected_xss/reflected_xss.php">Reflected XSS</a>
